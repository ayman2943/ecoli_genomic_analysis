...
# Analysis / Figure1.R
# ==============================================================================
# PROVENANCE: verbatim relocation of the original scripts/.../06a_temporal_mk.R.
#
# Reproduces submitted Figure 1 (temporal trend / Mann-Kendall analysis). Filename and internal title match exactly, corroborated twice during verification against the submitted Figure_01.png.
#
