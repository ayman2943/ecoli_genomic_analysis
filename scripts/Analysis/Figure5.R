...
# Analysis / Figure5.R
# ==============================================================================
# PROVENANCE: verbatim relocation of the original scripts/.../13_fig06_cluster_temporal.R.
#
# Reproduces submitted Figure 5 (per-cluster temporal burden trends with Kendall tau annotations; ST69 VFDB / ST10 VF / ST10 ResFinder). NOTE: the original filename says "fig06" -- that internal label is WRONG relative to the manuscript's final figure numbering; content matching against the submitted Figure_05.png confirms this script is actually the source of Figure 5, not Figure 6. Renamed here to reflect the confirmed, correct figure number.
#
