#!/usr/bin/env Rscript
# ==============================================================================
# Prerequisites / 03d_tree_mapping_vf.R
# ==============================================================================
# PROVENANCE: verbatim relocation of the original scripts/.../03d_tree_mapping_vf.R.
# Maps VirulenceFinder/ResFinder shell-gene clusters onto the core-genome tree (ST10). Same role as 03c above but for ST10.
#
