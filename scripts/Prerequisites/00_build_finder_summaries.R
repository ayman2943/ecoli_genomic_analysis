#!/usr/bin/env Rscript
# ==============================================================================
# Prerequisites / 00_build_finder_summaries.R
# ==============================================================================
# PROVENANCE: verbatim relocation of the original scripts/.../build_finder_summaries.R.
# Builds the VF/ResFinder binary summary matrices (config$VF_BINARY, resfinder_binary_matrix.tsv) from raw per-genome finder tool output. This is the earliest-running prerequisite: Virulence/VirulenceFinder.R and AMR/ResFinder.R both read the matrices this script produces.
#
