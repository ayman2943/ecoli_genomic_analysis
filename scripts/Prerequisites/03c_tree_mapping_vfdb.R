#!/usr/bin/env Rscript
# ==============================================================================
# Prerequisites / 03c_tree_mapping_vfdb.R
# ==============================================================================
# PROVENANCE: verbatim relocation of the original scripts/.../03c_tree_mapping_vfdb.R.
# Maps VFDB shell-gene clusters onto the core-genome tree (ST69). Produces tree_cluster_mapping.csv / pruned_tree.nwk, needed for Figure 3's iTOL rings (see Analysis/Figure3.R) and for the Supplementary tree-mapping sections.
#
