#!/usr/bin/env Rscript
# ==============================================================================
# Prerequisites / 02b_pangenome_shell_cluster_vfdb.R
# ==============================================================================
# PROVENANCE: verbatim relocation of the original scripts/.../02b_pangenome_shell_cluster_vfdb.R.
# Shell-gene clustering (silhouette + k-selection) on the VFDB pangenome. Produces the shell_cluster assignments that every Virulence/AMR/Analysis script depends on.
#
