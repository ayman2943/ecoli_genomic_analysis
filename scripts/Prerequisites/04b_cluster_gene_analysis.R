#!/usr/bin/env Rscript
# ==============================================================================
# Prerequisites / 04b_cluster_gene_analysis.R
# ==============================================================================
# PROVENANCE: verbatim relocation of the original scripts/.../04b_cluster_gene_analysis.R.
# Computes per-cluster gene-level statistics, writing to config$OUTPUT_DIR/cluster_gene_analysis/. Analysis/Figure6.R reads this output directly (confirmed via its read_csv() call) -- this script MUST run before Figure6.R.
#
