#!/usr/bin/env Rscript
#
# resistance_analysis.R  —  Shell-gene cluster AMR analysis
#
# Maps CARD and ResFinder to shell-gene clusters, detects temporal
# trends, selects the cluster with strongest AMR signal, and performs
# clinical enrichment + figures.
#
# Usage:
#   TARGET_ST=ST10 Rscript scripts/resistance_analysis.R
#
...
# -------------------------------------------------------------------
# 2. Define analysis function (used for CARD and ResFinder)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
cat("\n========================================\n")
cat("  RESISTANCE ANALYSIS COMPLETE -", st, "\n")
cat("========================================\n")
