#!/usr/bin/env Rscript
#
# virulence_analysis.R  —  Shell-gene cluster virulence analysis
#
# Maps VFDB and VirulenceFinder to shell-gene clusters, detects temporal
# trends, selects the cluster with strongest VF signal, and performs
# clinical enrichment + publication figures.
#
# Usage:
#   TARGET_ST=ST10 Rscript scripts/virulence_analysis.R
#
...
# -------------------------------------------------------------------
# 2. Define analysis function (used for VFDB and VF)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
cat("\n========================================\n")
cat("  VIRULENCE ANALYSIS COMPLETE -", st, "\n")
cat("========================================\n")
if (!is.null(res_vfdb)) {
